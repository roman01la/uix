...
(def list-view (adapt-fn (.-ListView ReactNative)))
...
(def masked-view-ios (adapt-fn (.-MaskedViewIOS ReactNative)))
...
(def slider (adapt-fn (.-Slider ReactNative)))
...
(def view-pager-android (adapt-fn (.-ViewPagerAndroid ReactNative)))
(def virtualized-list (adapt-fn (.-VirtualizedList ReactNative)))
(def web-view (adapt-fn (.-WebView ReactNative)))
